...
* [x] **Classifier**: unit tests for ambiguous inputs (Xtream as M3U, naked host, with/without scheme, with port).
* [x] **Xtream**: mock server returning JSON for `player_api.php`, with redirect and with 403 UA block.
